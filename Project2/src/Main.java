 ...
 * and adding features to this program in order to make it more efficient and accurate.
 https://github.com/davidju/Password_Hardening_Keystroke_Dynamics/blob/master/Main.java
 http://www.ijitee.org/attachments/File/v3i2/B1017073213.pdf
 https://compilr.com/nakaya/web/Program.java
 * 
 * @author David_Ju
 * @date April 17, 2013
 */
